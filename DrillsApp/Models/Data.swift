...
var drillData: [Drill]   = addStepCount(dd: tempData)
...
/*  addStepCount essentially copies over the data that has been stored in the tempData
      ...
      As a long term solution I would change the json so that step numbers were included.
 */
func addStepCount(dd: [Drill]) -> [Drill]{
