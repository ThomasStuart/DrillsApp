...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DrillsApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9DrillsApp11AppDelegate")
...
SWIFT_CLASS("_TtC9DrillsApp12PlayerUIView")
...
SWIFT_CLASS("_TtC9DrillsApp13SceneDelegate")
