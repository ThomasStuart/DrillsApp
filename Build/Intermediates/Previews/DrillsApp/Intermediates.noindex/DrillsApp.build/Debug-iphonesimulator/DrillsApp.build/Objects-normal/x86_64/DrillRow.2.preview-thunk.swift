...
extension DrillRow_Previews {
    @_dynamicReplacement(for: previews) private static var __preview__previews: some View {
      ...
      AnyView(Group {
        DrillRow(drill: drillData[__designTimeInteger("#9250.[3].[0].property.[0].[0].arg[0].value.[0].arg[0].value.[0].value", fallback: 0)])
        DrillRow(drill: drillData[__designTimeInteger("#9250.[3].[0].property.[0].[0].arg[0].value.[1].arg[0].value.[0].value", fallback: 1)])
      }
        .previewLayout(.fixed(width:__designTimeInteger("#9250.[3].[0].property.[0].[0].modifier[0].arg[0].value.arg[0].value", fallback: 300), height:__designTimeInteger("#9250.[3].[0].property.[0].[0].modifier[0].arg[0].value.arg[1].value", fallback: 70))))
#sourceLocation()
    }
}
