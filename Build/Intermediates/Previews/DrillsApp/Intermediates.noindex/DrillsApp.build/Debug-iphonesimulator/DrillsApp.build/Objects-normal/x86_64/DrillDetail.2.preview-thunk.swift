        ...
        #sourceLocation(file: "/Users/Thomas_Stuart/Desktop/XcodeProjects/DrillsApp/DrillsApp/DrillDetail.swift", line: 26)
         ...
         AnyView(VStack {
            ...
            Text(drill.videoURL ?? "no data")
             ...
             VStack{
                PlayerContainerView(player: AVPlayer(url: URL(string: mp4Data[0])!), videoTitle: __designTimeString("#9263.[3].[1].property.[0].[0].arg[0].value.[2].arg[0].value.[0].arg[1].value.[0].value", fallback: ""))
             }
            .frame(height: UIScreen.main.bounds.height / 3.5)
            
            
            VStack{
                Text(__designTimeString("#9263.[3].[1].property.[0].[0].arg[0].value.[3].arg[0].value.[0].arg[0].value.[0].value", fallback: "Benefits:"))
                    .font(.title)
            ...
            VStack{
                Text(__designTimeString("#9263.[3].[1].property.[0].[0].arg[0].value.[4].arg[0].value.[0].arg[0].value.[0].value", fallback: "Steps:"))
                    .font(.title)
