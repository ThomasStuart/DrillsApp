    ...
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        AnyView(List{ // this allows the view to be scrollable vertically
             ...
             VStack { // this encapsulates all of the drill data verticall as a stack.
                ...
                Spacer()
                    .frame(height:__designTimeInteger("#192.[2].[1].property.[0].[0].arg[0].value.[0].arg[0].value.[2].modifier[0].arg[0].value", fallback: 25))
                ...
                VStack(spacing: __designTimeInteger("#192.[2].[1].property.[0].[0].arg[0].value.[0].arg[0].value.[5].arg[0].value", fallback: 0)){//spacing setting adjust spacing between Stack elements
